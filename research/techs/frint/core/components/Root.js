        ...
        <div className="row">
          <div className="seven columns">
            ...
            <div>
              ...
              <ul>
                <li>
                  <strong>Foo</strong> (self): is from{" "}
                  <code>{this.props.foo.getAppName()}</code>
                </li>
                <li>
                  <strong>Bar</strong> (self): is from{" "}
                  <code>{this.props.bar.getAppName()}</code>
                </li>
                <li>
                  <strong>Baz</strong> (self): is from{" "}
                  <code>{this.props.baz.getAppName()}</code>
                </li>
              </ul>
            </div>
          </div>
...
export default observe(function (app) {
  const sidebarToggle$ = new BehaviorSubject(true).map((toggleValue) => {
    return {
