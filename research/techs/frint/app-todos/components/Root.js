  ...
  render() {
    return (
      <div>
        ...
        <label htmlFor="todoInput">Create a new Todo item</label>
...
export default observe(function (app) {
  ...
  const formInput$ = new BehaviorSubject("")::map((inputValue) => {
    return {
      inputValue,
    };
  });
  ...
  return state$::merge(actions$, formInput$)::scan(
    (props, emitted) => {
      return {
        ...props,
        ...emitted,
