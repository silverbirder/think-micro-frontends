    ...
    return (
      ...
      >
        {!this.props.showEditForm && (
          <p>
            {todo.title}[
            <a href="javascript:" onClick={() => this.props.edit(todo)}>
              edit
            </a>
            ] [
            <a
        ...
        {this.props.showEditForm && (
          <p>
            ...
            [
            <a href="javascript:" onClick={() => this.props.cancelEdit()}>
              cancel
            </a>
            ]
          </p>
        ...
        <p>
          Below is Region <strong>todo-item</strong> that is specific to this
          Todo item:
        </p>
...
export default observe(function (app) {
  ...
  return (
    streamProps()
      ...
      .setDispatch({ removeTodo }, store)

      // stream values
      .set(showEditForm$, (showEditForm) => ({ showEditForm }))
      .set(formInput$, (inputValue) => ({ inputValue }))
